...
var LegDiagram = /*#__PURE__*/function (_Component) {
  _inherits(LegDiagram, _Component);

  var _super = _createSuper(LegDiagram);
  ...
  function LegDiagram(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_onCloseButtonClick", function () {
      _this.props.setLegDiagram(null);
      ...
      leg.steps.map(function (step, stepIndex) {
        ...
        if (stepWidthPx > 30) {
          mainSvgContent.push( /*#__PURE__*/_react.default.createElement("g", {
            ...
            fill: "red"
          }, "\u2191", _this2._formatElevation(gain), '  '), loss <= -10 && /*#__PURE__*/_react.default.createElement("tspan", {
            fill: "green"
