 ...
 */
var ExistingAccountDisplay = /*#__PURE__*/function (_Component) {
  _inherits(ExistingAccountDisplay, _Component);

  var _super = _createSuper(ExistingAccountDisplay);

  function ExistingAccountDisplay() {
    _classCallCheck(this, ExistingAccountDisplay);

    return _super.apply(this, arguments);
  }

  _createClass(ExistingAccountDisplay, [{
    key: "render",
    value: function render() {
      ...
      var paneSequence = [{
        pane: function pane() {
          return /*#__PURE__*/_react.default.createElement("p", null, /*#__PURE__*/_react.default.createElement(_linkButton.default, {
            to: "/savedtrips"
          }, "Edit my trips"));
        },
        title: 'My trips'
