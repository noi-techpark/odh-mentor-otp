 ...
 */
var UserAccountScreen = /*#__PURE__*/function (_Component) {
  _inherits(UserAccountScreen, _Component);

  var _super = _createSuper(UserAccountScreen);
  ...
  function UserAccountScreen(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_updateUserState", function (newUserData) {
      ...
      _this.setState({
        userData: _objectSpread(_objectSpread({}, userData), newUserData)
      });
    });

    _defineProperty(_assertThisInitialized(_this), "_updateUserPrefs", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_handleExitAndSave", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
