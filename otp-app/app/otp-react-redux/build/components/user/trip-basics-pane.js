 ...
 */
var TripBasicsPane = /*#__PURE__*/function (_Component) {
  _inherits(TripBasicsPane, _Component);

  var _super = _createSuper(TripBasicsPane);

  function TripBasicsPane() {
    var _this;

    _classCallCheck(this, TripBasicsPane);
    ...
    _defineProperty(_assertThisInitialized(_this), "_handleTripDaysChange", function (e) {
      var onMonitoredTripChange = _this.props.onMonitoredTripChange;
      onMonitoredTripChange((0, _monitoredTrip.arrayToDayFields)(e));
    });

    _defineProperty(_assertThisInitialized(_this), "_handleTripNameChange", function (e) {
      var onMonitoredTripChange = _this.props.onMonitoredTripChange;
