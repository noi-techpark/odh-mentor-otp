...
function PrintableItinerary({
  ...
  return /*#__PURE__*/_react.default.createElement(Styled.PrintableItinerary, {
    className: className
  }, itinerary.legs.length > 0 && /*#__PURE__*/_react.default.createElement(Styled.CollapsedTop, null, /*#__PURE__*/_react.default.createElement(Styled.LegBody, null, /*#__PURE__*/_react.default.createElement(Styled.LegHeader, null, /*#__PURE__*/_react.default.createElement("b", null, "Parti"), " da ", /*#__PURE__*/_react.default.createElement("b", null, itinerary.legs[0].from.name)))), itinerary.legs.map((leg, k) => leg.transitLeg ? /*#__PURE__*/_react.default.createElement(_transitLeg.default, {
