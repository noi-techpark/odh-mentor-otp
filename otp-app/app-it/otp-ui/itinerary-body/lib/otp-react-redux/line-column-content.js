...
})(["", " background-color:", ";bottom:-11px;position:absolute;top:11px;z-index:10;"], props => getLegCSS(props.mode), props => _coreUtils.default.itinerary.isTransit(props.mode) ? props.routeColor ? `#${props.routeColor}` : "#008" : undefined);
