...
function AccessLegSummary({
  ...
  return /*#__PURE__*/_react.default.createElement(Styled.LegClickable, {
    ...
    leg: leg
  })), /*#__PURE__*/_react.default.createElement(Styled.LegDescription, null, (0, _itinerary.getLegModeLabel)(leg), " ", leg.distance > 0 && /*#__PURE__*/_react.default.createElement("span", null, " ", (0, _humanizeDistance.humanizeDistanceString)(leg.distance)), ` verso ${(0, _itinerary.getPlaceName)(leg.to, config.companies)}`));
}
