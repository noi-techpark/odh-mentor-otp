...
function AccessLegSteps({
  ...
  return /*#__PURE__*/_react.default.createElement(Styled.Steps, null, steps.map((step, k) => {
    ...
    })), /*#__PURE__*/_react.default.createElement(Styled.StepDescriptionContainer, null, (0, _itinerary.getStepDirection)(step), /*#__PURE__*/_react.default.createElement("span", null, step.relativeDirection === "ELEVATOR" ? " verso " : " su "), /*#__PURE__*/_react.default.createElement(Styled.StepStreetName, null, (0, _itinerary.getStepStreetName)(step))));
  }));
}
