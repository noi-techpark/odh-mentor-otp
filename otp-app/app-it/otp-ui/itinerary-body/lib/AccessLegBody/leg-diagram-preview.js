...
class LegDiagramPreview extends _react.Component {
  ...
  render() {
    ...
    }, /*#__PURE__*/_react.default.createElement(Styled.PreviewDiagramTitle, null, "Altimetria", " ", /*#__PURE__*/_react.default.createElement(Styled.PreviewDiagramElevationGain, null, "\u2191", this.formatElevation(profile.gain * METERS_TO_FEET), "  "), /*#__PURE__*/_react.default.createElement(Styled.PreviewDiagramElevationLoss, null, "\u2193", this.formatElevation(-profile.loss * METERS_TO_FEET))), profile.points.length > 0 ? generateSvg(profile, width) : "Altimetria non disponibile.", /*#__PURE__*/_react.default.createElement(_reactResizeDetector.default, {
      handleWidth: true,
