...
class Endpoint extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "swapLocation", () => {
      ...
      this.clearLocation();
      const otherType = type === "from" ? "destinazione" : "origine";
      setLocation({
        type: otherType,
        location
      });
  ...
  render() {
    ...
    const otherType = type === "from" ? "destinazione" : "origine";
    const originalType = type === "from" ? "origine" : "destinazione";
    ...
    return /*#__PURE__*/_react.default.createElement(_reactLeaflet.Marker, {
      ...
      type: "times"
    }), " Rimuovi come ", originalType, "")), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(Styled.Button, {
      onClick: this.swapLocation
    }, /*#__PURE__*/_react.default.createElement(UserLocationIcon, {
      type: "refresh"
  }), " Cambia come ", otherType, " ", "")))));
  }
