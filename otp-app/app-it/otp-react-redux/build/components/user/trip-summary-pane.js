...
var TripSummaryPane = /*#__PURE__*/function (_Component) {
  _inherits(TripSummaryPane, _Component);

  var _super = _createSuper(TripSummaryPane);

  function TripSummaryPane() {
    _classCallCheck(this, TripSummaryPane);

    return _super.apply(this, arguments);
  }

  _createClass(TripSummaryPane, [{
    key: "render",
    value: function render() {
      ...
      if (!itinerary) {
        ...
        var capitalizedDays = (0, _monitoredTrip.dayFieldsToArray)(monitoredTrip).map(function (day) {
          return "".concat(day.charAt(0).toUpperCase()).concat(day.substr(1));
        });
