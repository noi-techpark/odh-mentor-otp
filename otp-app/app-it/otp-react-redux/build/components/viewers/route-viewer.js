...
var RouteViewer = /*#__PURE__*/function (_Component) {
  _inherits(RouteViewer, _Component);

  var _super = _createSuper(RouteViewer);
  ...
  _createClass(RouteViewer, [{
    ...
    value: function render() {
      ...
      var sortedRoutes = routes ? Object.values(routes).sort(_coreUtils.default.route.routeComparator) : [];
...
var RouteRow = /*#__PURE__*/function (_PureComponent) {
  _inherits(RouteRow, _PureComponent);

  var _super2 = _createSuper(RouteRow);
