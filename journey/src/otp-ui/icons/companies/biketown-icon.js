...
const BiketownIcon = ({ title, ...props }) => (
  <svg
  ...
  >
    ...
    <polygon points="141 74.27 117.92 74.27 103.7 40.02 104.27 74.27 82.87 74.27 82.87 0 104.27 0 103.7 31.84 116.33 0 138.9 0 121.81 35.84 141 74.27" />
    <path
    ...
    <path
      ...
      transform="translate(-37 -357)"
    />
    <polygon points="140.86 0 140.86 74.27 180.62 74.27 180.62 56.47 162.25 56.47 162.25 45.07 178.72 45.07 178.72 27.27 162.25 27.27 162.25 17.8 189.71 17.8 189.71 74.27 211.1 74.27 211.1 17.8 223.37 17.8 223.37 0 140.86 0" />
  </svg>
);
