...
var _parking = require("../../actions/parking");
...
class ParkingOverlay extends _reactLeaflet.MapLayer {
  constructor(...args) {
    super(...args);
  ...
  _startRefreshing() {
    ...
    this.props.parkingLocationsQuery(this.props.api); // set up timer to refresh stations periodically
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_reactLeaflet.FeatureGroup, null, locations.map(location => {
      ...
      }), " ", location.name), /*#__PURE__*/_react.default.createElement("div", {
        className: "popup-row"
      }, /*#__PURE__*/_react.default.createElement("i", {
        className: "fa fa-car",
        style: bulletIconStyle
      }), " ", location.free, " Vehicles"), /*#__PURE__*/_react.default.createElement("div", {
        className: "popup-row"
...
_defineProperty(ParkingOverlay, "propTypes", {
  api: _propTypes.default.string,
  locations: _propTypes.default.array,
  parkingLocationsQuery: _propTypes.default.func,
...
const mapDispatchToProps = {
  ...
  parkingLocationsQuery: _parking.parkingLocationsQuery
};

var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)((0, _reactLeaflet.withLeaflet)(ParkingOverlay));

exports.default = _default;
module.exports = exports.default;

//# sourceMappingURL=parking-overlay.js