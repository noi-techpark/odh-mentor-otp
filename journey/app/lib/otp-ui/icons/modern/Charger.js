...
const Charger = ({ title, width = 26, height = 22, iconColor = '#000', ...props }) => (
	<svg xmlns="http://www.w3.org/2000/svg" width="54" height="61.96" viewBox="0 0 54 61.96">
	  <g id="Group_165" data-name="Group 165" transform="translate(-1323.585 -290.965)">
	    <g id="noun_Charging_Station_976545" data-name="noun_Charging Station_976545" transform="translate(1329.162 295.042)">
	      <rect id="Rectangle_38" data-name="Rectangle 38" width="54" height="51" rx="10" transform="translate(-5.577 -4.077)" fill="#ffef35"/>
	      <path id="Path_21" data-name="Path 21" d="M798.4,1802.6l10.96,10.96,10.96-10.96Z" transform="translate(-787.942 -1755.678)" fill="#ffef35"/>
