...
const zoom = 13;
(0, _react2.storiesOf)("ParkAndRideOverlay", module).addDecorator(_addonA11y.withA11y).addDecorator(_addonInfo.withInfo).add("ParkAndRideOverlay", () => /*#__PURE__*/_react.default.createElement(_src.default, {
  center: center,
  zoom: zoom
