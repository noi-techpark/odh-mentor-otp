...
const stacked = (0, _styledComponents.css)`
  left: 0;
  position: absolute;
  text-align: center;
`;
...
const StackedToIcon = (0, _styledComponents.default)(StackedLocationIcon)`
  color: #333;
`;
exports.StackedToIcon = StackedToIcon;
const StackedIconContainer = _styledComponents.default.span`
